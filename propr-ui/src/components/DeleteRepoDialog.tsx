              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    ...
                    <code className="px-1.5 py-0.5 bg-gray-100 text-gray-700 text-xs font-mono rounded-md border border-gray-200">
                      {repoName}
                    </code>
                    ?
                  </p>
                  <p className="text-sm text-gray-600">
                    This will remove the repository from your monitored list. The repository itself will not be affected on GitHub.
                  </p>
                </div>
              </div>
            </div>

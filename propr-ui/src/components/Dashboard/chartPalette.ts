 ...
 *
 * History is neutral. A day that has already closed cannot be acted on, so it
 * is drawn in slate however many completions it holds; only the day still
 * accumulating takes brand teal. This lives apart from the chart component so

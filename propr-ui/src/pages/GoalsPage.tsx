...
function GoalDetails({ goalId }: { goalId: string }) {
  ...
  return <div className="mx-auto max-w-6xl space-y-5 p-4 sm:p-6">
    ...
    <section className="rounded-lg border bg-slate-950 p-4 text-slate-100"><ExecutionEventLog events={live.events} collapsed={false} onToggleCollapse={() => undefined} lastThought={null} isTaskActive={!terminal && goal.desiredState === 'running'} taskInfo={null} /></section>
  </div>;
}

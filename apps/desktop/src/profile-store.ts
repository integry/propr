...
export class ProfileStore {
  ...
  save(input: DesktopProfileInput, signal?: AbortSignal): Promise<DesktopProfile> {
    ...
    return this.saveAndDetachCredential(
      input,
      undefined,
  ...
  saveAndDetachCredential(
    ...
    return this.#mutate(async () => {
      ...
      const durable = await this.#writeState(state, isCurrent);
      if (!durable) throw new DOMException('The desktop profile save was cancelled.', 'AbortError');

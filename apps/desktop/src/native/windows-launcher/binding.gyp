{
  "targets": [
    ...
    {
      "target_name": "propr_windows_build_bootstrap",
      "sources": ["propr_windows_launcher.cc"],
      "defines": ["NAPI_VERSION=9", "UNICODE", "_UNICODE", "WIN32_LEAN_AND_MEAN", "NOMINMAX", "_WIN32_WINNT=0x0602", "PROPR_WINDOWS_BOOTSTRAP_ONLY=1", "PROPR_WINDOWS_BUILD_BOOTSTRAP=1"],
      "libraries": ["-ladvapi32", "-lbcrypt", "-lcrypt32", "-lwintrust"],
      "msvs_settings": {
        "VCCLCompilerTool": {
          "ExceptionHandling": 1,

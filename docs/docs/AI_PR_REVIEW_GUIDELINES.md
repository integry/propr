...
This document provides comprehensive guidelines for human reviewers assessing pull requests generated by Claude Code in the ProPR automated issue processing system.

## Overview

The ProPR system uses Anthropic's Claude Code to automatically analyze GitHub issues, generate solutions, and create pull requests. While Claude Code is highly capable, human review remains essential to ensure quality, security, and adherence to project standards.

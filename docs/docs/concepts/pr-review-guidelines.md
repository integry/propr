...
This document provides comprehensive guidelines for human reviewers assessing pull requests generated by ProPR's AI agents.

## Overview

The ProPR system can use configured AI agents to analyze GitHub issues, generate solutions, and create pull requests. While these agents are highly capable, human review remains essential to ensure quality, security, and adherence to project standards.
...
- **Repository Guidance Files:** Ensure compliance with project-specific guidance files such as `CLAUDE.md` when available
...
2. **Categorize Issues:** Help identify whether issues are due to:
   ...
   - Agent comprehension errors
   - Missing information in repository guidance files such as `CLAUDE.md`

3. **Report System Issues:** If you notice a specific agent consistently misunderstanding certain types of issues, report this to the system maintainers
...
- **System bugs:** Report agent processing issues to system maintainers

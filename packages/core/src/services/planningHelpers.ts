...
import { Plan } from '../claude/prompts/plannerPrompts.js';
import { buildFullContext, Granularity, Base64Image } from './contextBuilder.js';

// Re-export types from contextBuilder for backwards compatibility
export { buildFullContext, Granularity, Base64Image } from './contextBuilder.js';

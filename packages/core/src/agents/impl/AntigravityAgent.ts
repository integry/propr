...
export class AntigravityAgent implements Agent {
    ...
    private getRuntimeName(): 'antigravity' { return 'antigravity'; }
    private getContainerConfigPath(): string { return ANTIGRAVITY_CONTAINER_CONFIG_PATH; }
    private getCliCommand(): string { return 'agy'; }
    private getHostConfigPath(): string { return resolveConfigPath(process.env.ANTIGRAVITY_CONFIG_PATH || this.config.configPath); }

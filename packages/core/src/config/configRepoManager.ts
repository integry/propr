...
export async function saveFollowupKeywords(keywords: string[], commitMessage?: string): Promise<boolean> {
...
export async function saveMonitoredRepos(repos: RepoToMonitor[], commitMessage?: string): Promise<boolean> {
...
export async function saveSettings(settings: ConfigSettings, commitMessage?: string): Promise<boolean> {
...
export async function savePrLabel(prLabel: string, commitMessage?: string): Promise<boolean> {
...
export async function saveAiPrimaryTag(aiPrimaryTag: string, commitMessage?: string): Promise<boolean> {
...
export async function savePrimaryProcessingLabels(primaryLabels: string[] | string, commitMessage?: string): Promise<boolean> {
 ...
 */
export async function saveAgents(agents: AgentConfig[], commitMessage?: string): Promise<boolean> {

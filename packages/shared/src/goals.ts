...
export const GOAL_STATE_TRANSITIONS: Record<GoalState, readonly GoalState[]> = {
  queued: ['planning', 'running', 'pausing', 'cancelling', 'cancelled', 'failed'],
  planning: ['running', 'pausing', 'completing', 'cancelling', 'cancelled', 'failed'],
  running: ['pausing', 'recovering', 'completing', 'cancelling', 'cancelled', 'failed'],
  pausing: ['paused', 'cancelling', 'cancelled', 'failed'],
  paused: ['planning', 'running', 'recovering', 'cancelling', 'cancelled', 'failed'],
  cancelling: ['cancelled', 'failed'],
  recovering: ['running', 'planning', 'pausing', 'cancelling', 'cancelled', 'failed'],

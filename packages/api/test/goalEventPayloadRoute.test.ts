...
test('event route projects poisoned nested payloads without mutating persistence', async () => {
  ...
  const poisonedPayload = {
    ...
    xApiKey: 'short-one', 'X-API-Key': 'short-two', accessKey: 'short-access', auth_key: 'short-auth', 'signing-key': 'short-signing', nestedAccessKeyId: 'short-access-id', apiKeyValue: 'kv', encryptionKeyMaterial: 'km', opaqueKeyId: 'ki', backupkeymaterial: 'bk',

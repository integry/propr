...
import { requireManageAgents, requireManageMembers, requireManageSettings } from './permissionGuards.js';
...
function setupRoutes(): void {
  ...
  const [agentRuntimeRoutes, adminRoutes] = [createAgentRuntimeRoutes({ getRuntimeBuildQueue: () => runtimeBuildQueue }), createAdminRoutes()];
  ...
  const routes: RouteEntry[] = [
    ...
    ['get', '/api/task/:taskId/file-changes', fileChangesRoutes.getFileChanges], ['get', '/api/config/followup-keywords', configRoutes.getFollowupKeywords], ['post', '/api/config/followup-keywords', requireManageSettings, configRoutes.postFollowupKeywords], ['get', '/api/config/followup-ignore-keywords', configRoutes.getFollowupIgnoreKeywords],
    ['post', '/api/config/followup-ignore-keywords', requireManageSettings, configRoutes.postFollowupIgnoreKeywords], ['get', '/api/config/repos', configRoutes.getRepos], ['post', '/api/config/repos', requireManageSettings, configRoutes.postRepos], ['get', '/api/config/settings', configRoutes.getSettings],
    ['post', '/api/config/settings', requireManageSettings, configRoutes.postSettings], ['get', '/api/config/pr-label', configRoutes.getPrLabel], ['post', '/api/config/pr-label', requireManageSettings, configRoutes.postPrLabel], ['get', '/api/config/ai-primary-tag', configRoutes.getAiPrimaryTag],
    ['post', '/api/config/ai-primary-tag', requireManageSettings, configRoutes.postAiPrimaryTag], ['get', '/api/config/primary-processing-labels', configRoutes.getPrimaryProcessingLabels], ['post', '/api/config/primary-processing-labels', requireManageSettings, configRoutes.postPrimaryProcessingLabels], ['get', '/api/config/agents', configRoutes.getAgents],
    ['post', '/api/config/agents', requireManageAgents, configRoutes.postAgents], ['get', '/api/config/summarization', configRoutes.getSummarizationSettings], ['post', '/api/config/summarization', requireManageSettings, configRoutes.postSummarizationSettings], ['get', '/api/config/repos/indexing-status', configRoutes.getRepositoriesIndexingStatus],
    ['post', '/api/config/repos/trigger-indexing', requireManageSettings, configRoutes.triggerIndexing], ['post', '/api/config/repos/stop-indexing', requireManageSettings, configRoutes.stopIndexing], ['post', '/api/config/summarization/reindex-all', requireManageSettings, configRoutes.triggerReindexAll], ['get', '/api/config/agent-tank', configRoutes.getAgentTankSettings],
    ['post', '/api/config/agent-tank', requireManageAgents, configRoutes.postAgentTankSettings], ['get', '/api/config/agent-tank/status', configRoutes.getAgentTankStatus], ['get', '/api/config/agent-tank/usage', configRoutes.getAgentTankUsage], ['post', '/api/config/agent-tank/refresh', requireManageAgents, configRoutes.postAgentTankRefresh],
    ...
    ['post', '/api/admin/members/claim', requireManageMembers, adminRoutes.claimAdmin], ['post', '/api/admin/members', requireManageMembers, adminRoutes.addMember],
  ...
  app.use('/api/agents/opencode/models', requireManageAgents);

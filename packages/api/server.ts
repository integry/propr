...
function setupRoutes(): void {
  ...
  const routes: RouteEntry[] = [
    ...
    ['get', '/api/admin/members', requireManageMembers, adminRoutes.listMembers], ['get', '/api/admin/role-audit', requireManageMembers, adminRoutes.listRoleAudit],
    ['post', '/api/admin/members/claim', requireManageMembers, adminRoutes.claimBootstrapAdmin], ['post', '/api/admin/members', requireManageMembers, adminRoutes.addMember],
    ['patch', '/api/admin/members/:githubUserId', requireManageMembers, adminRoutes.updateMemberRole], ['delete', '/api/admin/members/:githubUserId', requireManageMembers, adminRoutes.removeMember],

...
function setupRoutes(): void {
  ...
  const operationalRoutes: RouteEntry[] = [
    ...
    ['get', '/api/task/:taskId/file-changes', fileChangesRoutes.getFileChanges], ['get', '/api/queue/stats', queueRoutes.getQueueStats], ['get', '/api/live-activity', createLiveActivityRoutes({ db, taskQueue }).getLiveActivity], ['get', '/api/activity', queueRoutes.getActivity], ['get', '/api/metrics', queueRoutes.getMetrics],

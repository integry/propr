...
import { requireManageAgents, requireManageMembers, requireManageRuntime, requireManageSettings } from './permissionGuards.js';

type RouteEntry = ['get' | 'post' | 'put' | 'patch' | 'delete', string, ...RequestHandler[]];
...
function setupRoutes(): void {
  ...
  const register = (method: RouteEntry[0], path: string, ...handlers: RequestHandler[]): void => {
  ...
  const routes: RouteEntry[] = [
    ...
    ['get', '/api/task/:taskId/file-changes', fileChangesRoutes.getFileChanges], ['get', '/api/config/followup-keywords', requireManageSettings, configRoutes.getFollowupKeywords], ['post', '/api/config/followup-keywords', requireManageSettings, configRoutes.postFollowupKeywords], ['get', '/api/config/followup-ignore-keywords', requireManageSettings, configRoutes.getFollowupIgnoreKeywords],
    ['post', '/api/config/followup-ignore-keywords', requireManageSettings, configRoutes.postFollowupIgnoreKeywords], ['get', '/api/config/repos', requireManageSettings, configRoutes.getRepos], ['post', '/api/config/repos', requireManageSettings, configRoutes.postRepos], ['get', '/api/config/settings', requireManageSettings, configRoutes.getSettings],
    ['post', '/api/config/settings', requireManageSettings, configRoutes.postSettings], ['get', '/api/config/pr-label', requireManageSettings, configRoutes.getPrLabel], ['post', '/api/config/pr-label', requireManageSettings, configRoutes.postPrLabel], ['get', '/api/config/ai-primary-tag', requireManageSettings, configRoutes.getAiPrimaryTag],
    ['post', '/api/config/ai-primary-tag', requireManageSettings, configRoutes.postAiPrimaryTag], ['get', '/api/config/primary-processing-labels', requireManageSettings, configRoutes.getPrimaryProcessingLabels], ['post', '/api/config/primary-processing-labels', requireManageSettings, configRoutes.postPrimaryProcessingLabels], ['get', '/api/config/agents', requireManageAgents, configRoutes.getAgents],
    ['post', '/api/config/agents', requireManageAgents, configRoutes.postAgents], ['get', '/api/config/summarization', requireManageSettings, configRoutes.getSummarizationSettings], ['post', '/api/config/summarization', requireManageSettings, configRoutes.postSummarizationSettings], ['get', '/api/config/repos/indexing-status', requireManageSettings, configRoutes.getRepositoriesIndexingStatus],
    ['post', '/api/config/repos/trigger-indexing', requireManageSettings, configRoutes.triggerIndexing], ['post', '/api/config/repos/stop-indexing', requireManageSettings, configRoutes.stopIndexing], ['post', '/api/config/summarization/reindex-all', requireManageSettings, configRoutes.triggerReindexAll], ['get', '/api/config/agent-tank', requireManageAgents, configRoutes.getAgentTankSettings],
    ['post', '/api/config/agent-tank', requireManageAgents, configRoutes.postAgentTankSettings], ['get', '/api/config/agent-tank/status', requireManageAgents, configRoutes.getAgentTankStatus], ['get', '/api/config/agent-tank/usage', requireManageAgents, configRoutes.getAgentTankUsage], ['post', '/api/config/agent-tank/refresh', requireManageAgents, configRoutes.postAgentTankRefresh],
    ['get', '/api/config/agent-tank/detect', requireManageAgents, configRoutes.getAgentTankDetect], ['get', '/api/catalog', instanceCatalogRoutes.getCatalog], ['get', '/api/repositories/indexing-status', configRoutes.getRepositoriesIndexingStatus], ['get', '/api/queue/stats', queueRoutes.getQueueStats], ['get', '/api/activity', queueRoutes.getActivity], ['get', '/api/metrics', queueRoutes.getMetrics],
    ...
    ['get', '/api/admin/members', requireManageMembers, adminRoutes.listMembers], ['get', '/api/admin/role-audit', requireManageMembers, adminRoutes.listRoleAudit], ['post', '/api/admin/members/claim', requireManageMembers, adminRoutes.claimBootstrapAdmin],
    ['post', '/api/admin/members', requireManageMembers, adminRoutes.addMember], ['patch', '/api/admin/members/:githubUserId', requireManageMembers, adminRoutes.updateMemberRole], ['delete', '/api/admin/members/:githubUserId', requireManageMembers, adminRoutes.removeMember],
    ['get', '/api/agent-runtime/packages', requireManageRuntime, agentRuntimeRoutes.getRuntimePackages], ['get', '/api/agent-runtime/packages/search', requireManageRuntime, agentRuntimeRoutes.searchRuntimePackages], ['post', '/api/agent-runtime/packages/validate', requireManageRuntime, agentRuntimeRoutes.validateRuntimePackages],
    ['put', '/api/agent-runtime/packages', requireManageRuntime, agentRuntimeRoutes.putRuntimePackages], ['post', '/api/agent-runtime/packages/apply', requireManageRuntime, agentRuntimeRoutes.applyRuntimePackages],
    ['post', '/api/agents/:agentId/login-sessions', requireManageAgents, agentLoginRoutes.startLogin], ['get', '/api/agents/:agentId/login-sessions/:sessionId', requireManageAgents, agentLoginRoutes.getLogin],
    ['post', '/api/agents/:agentId/login-sessions/:sessionId/input', requireManageAgents, agentLoginRoutes.sendInput], ['delete', '/api/agents/:agentId/login-sessions/:sessionId', requireManageAgents, agentLoginRoutes.cancelLogin],
  ];
  ...
  agentVersionRouteEntries.forEach(([method, path, ...handlers]) => register(method, path, ...handlers));
